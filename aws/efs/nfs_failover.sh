...
aws route53 change-resource-record-sets --hosted-zone-id XXXXXXXXXXXXXXX --change-batch file://primary.json
mkdir efs
...
ls efs
aws route53 change-resource-record-sets --hosted-zone-id XXXXXXXXXXXXXXXX --change-batch file://secondary.json
